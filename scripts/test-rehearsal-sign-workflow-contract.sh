...
grep -Fq 'ASTRID_SOURCE_COMMIT: 220c692336aac89f035134c1399e1d91fab3b3d5' "$workflow"
grep -Fq 'tag = "rehearsal-only-220c692336aac89f035134c1399e1d91fab3b3d5"' "$workflow"
grep -Fq '@workflow_dispatch/220c692336aac89f035134c1399e1d91fab3b3d5"' "$workflow"
grep -Fq 'source-commit = "220c692336aac89f035134c1399e1d91fab3b3d5"' "$workflow"
