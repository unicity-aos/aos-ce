...
grep -Fq 'ASTRID_SOURCE_COMMIT: 4fe0cfd64aac7f7d0a8a88284f887ef2788d7a94' "$workflow"
grep -Fq 'tag = "rehearsal-only-4fe0cfd64aac7f7d0a8a88284f887ef2788d7a94"' "$workflow"
grep -Fq '@workflow_dispatch/4fe0cfd64aac7f7d0a8a88284f887ef2788d7a94"' "$workflow"
grep -Fq 'source-commit = "4fe0cfd64aac7f7d0a8a88284f887ef2788d7a94"' "$workflow"
