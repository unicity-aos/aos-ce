...
grep -Fq 'ASTRID_SOURCE_COMMIT: 1897e086549ac447c6b6cc47ad264a500ebe9fcb' "$workflow"
grep -Fq 'tag = "rehearsal-only-1897e086549ac447c6b6cc47ad264a500ebe9fcb"' "$workflow"
grep -Fq '@workflow_dispatch/1897e086549ac447c6b6cc47ad264a500ebe9fcb"' "$workflow"
grep -Fq 'source-commit = "1897e086549ac447c6b6cc47ad264a500ebe9fcb"' "$workflow"
